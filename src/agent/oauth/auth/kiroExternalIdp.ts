...
export function validateMicrosoftTokenEndpoint(rawEndpoint: unknown) {
...
export function normalizeScope(scopes: unknown) {
...
export function decodeJwtPayload(jwt: unknown) {
  try {
...
function resolveExpiresAt(input: AuthPayload) {
...
export function normalizeKiroExternalIdpAuth(rawAuth: AuthPayload | string) {
  let input = rawAuth;
...
export function buildExternalIdpRefreshParams(refreshToken: string, providerSpecificData: AuthPayload = {}) {
