...
import { ANTIGRAVITY_OAUTH_CLIENT, GOOGLE_OAUTH_CLIENT } from "../../protocols/providers/shared.js";
import { PROVIDER_OAUTH, PROVIDERS as REGISTRY_PROVIDERS } from "../../protocols/providers/index.js";
...
export const ANTIGRAVITY_CONFIG: AuthConfig = {
...
export function assertValidAwsRegion(region: string) {
...
// See ../protocols/shared/zedAuth.ts for the keypair/decrypt helpers.
