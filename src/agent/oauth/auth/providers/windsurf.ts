...
async function windsurfSeatRequest(baseUrl: string, path: string, body: AuthPayload) {
...
function parseWindsurfCallback(raw: unknown, expectedState: string) {
