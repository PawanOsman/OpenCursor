...
/**
 * Qoder COSY (hybrid RSA+AES+MD5) request signing.
 *
...
import { QODER_CLIENT_TYPE, QODER_DATA_POLICY, QODER_IDE_VERSION, QODER_LOGIN_VERSION, QODER_MACHINE_OS, QODER_MACHINE_TYPE, QODER_RSA_PUBLIC_KEY, } from "./constants.js";
...
function encryptUserInfo(userInfo: ProtocolValue) {
