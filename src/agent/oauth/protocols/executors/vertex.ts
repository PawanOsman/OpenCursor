 ...
 */
function parseVertexAdcJson(apiKey: ProtocolValue) {
 ...
 */
async function resolveProjectId(apiKey: ProtocolValue) {
  ...
  const json = await res.json().catch(() => null) as ProtocolRecord | ProtocolRecord[] | null;
