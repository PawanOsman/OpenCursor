 ...
 * Encodes timestamp and machine identity for request authentication.
 */
 ...
 */
export function generateHashed64Hex(input: ProtocolValue, salt = "") {
 ...
 */
export function generateSessionId(authToken: ProtocolValue) {
 ...
 */
export function generateCursorChecksum(machineId: ProtocolValue) {
 ...
 */
export function buildCursorHeaders(accessToken: ProtocolValue, machineId: ProtocolValue = null, ghostMode = true) {
