...
// Parse SSE data line
export function parseSSELine(line: ProtocolValue, format: ProtocolValue = null) {
    if (!line)
        return null;
...
export function hasValuableContent(chunk: ProtocolValue, format: string) {
    // OpenAI format
...
export function fixInvalidId(parsed: ProtocolValue) {
...
function cleanUsagePayload(payload: ProtocolRecord) {
...
export function formatSSE(data: ProtocolValue, sourceFormat: string) {
...
export function buildStreamErrorBytes(statusCode: number, message: ProtocolRecord, clientFormat: ProtocolValue) {
